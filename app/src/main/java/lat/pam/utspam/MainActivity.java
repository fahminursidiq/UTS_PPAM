...
public class MainActivity extends AppCompatActivity {
    ...
    public void login() {
        ...
        Log.d("print", String.valueOf(username.equals("1197050036")));
        Log.d("print", String.valueOf(password.equals("fahmi")));
        //Cek apakah username dan password benar
        if (username.equals("1197050036") && password.equals("fahmi")) {
